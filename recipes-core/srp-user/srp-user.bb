...
GROUPADD_PARAM:${PN} = "-g 1000 srp ; -g 890 group2;--system gpio;--system i2c;--system tty;--system bin"

# Likewise, we'll manage group3 in the useradd-example-user3 package:
GROUPADD_PARAM:${PN}-user3 = "-g 900 group3"

USERADD_PARAM:${PN} = "-u 1000 -d /home/srpapp -r -s /bin/bash --groups srp,gpio,i2c,tty,bin srpapp"
...
do_install () {
	...
	install -p -m 644 file1 ${D}${datadir}/srpapp/
